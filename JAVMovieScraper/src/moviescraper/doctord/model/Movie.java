    ...
    */
    ...
    public static String getFileNameOfNfo(File file, boolean nfoNamedMovieDotNfo) {
        if (nfoNamedMovieDotNfo) {
            //fixed folder issue here - missing check for directory or file
            if (file.isDirectory()) {
                return file.getPath() + File.separator + "movie.nfo";
            } else {
                return file.getParent() + File.separator + "movie.nfo";
            }
            //return  file.getCanonicalPath() + File.separator + "movie.nfo";
    ...
    public void setFileName(String fileName) {
        ...
        //CHANGED: iheartporn - check preference to see if the options is selected
        if(MoviescraperPreferences.getInstance().getUseFileNameForOriginalTitle()) {
            if (this.originalTitle.getOriginalTitle().isEmpty()) {
                this.setOriginalTitle(new OriginalTitle(fileName));
            }
        }
    }
